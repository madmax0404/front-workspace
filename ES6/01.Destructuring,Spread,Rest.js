...
const {bao, option = ""/* 기본값 */} = obj;
console.log(bao, option); // option 에는 undefined
...
// 객체 전개
const person = {name: 'hjy', job: 'student'};
const hjy = {...person, location: 'Seoul'};
console.log(hjy);
...
const person2 = {name: 'hjy', age: 37, hobby: ['Kaggle', 'Reading'], location: 'Seoul'};
testRest2(person2);
