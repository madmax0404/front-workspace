...
// 화살표 함수
const declareFn1 = (a, b) => a*b;
// console.log(declareFn1(2,3));
const declareFn3 = a => a*2;

// 2. this 바인딩
// - this 는 모든 함수에 묵시적으로 존재하는 예약어.
...
// 3. 화살표 함수의 this
// - 화살표 함수는 자신만의 this를 가질 수 없도록 설계되어 있다.
 ...
 * - this가 동적으로 바인딩 되어야 하는 경우(객체의 메서드나 생성자 함수)
...
function printName(greeting, target) {
    console.log(`${greeting}, ${this.name}, ${target}`);
}

printName.apply({name: "hjy"}, ["Hello", "Mr. Han"]);

// 3) bind(thisArg)
// - 함수를 실행하지 않고, this가 바인딩 된 새로운 함수를 반환
// - 함수의 this 값을 미리 바인딩 해둬야 하는 경우 사용
const bindFn = user.printName.bind({name: 'Jongyun'});
bindFn();